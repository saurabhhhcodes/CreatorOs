...
const urlShortenSchema = z
  .object({
    ...
    customSlug: z
      ...
      .regex(
        /^[a-z0-9-_]{3,32}$/,
        "Custom slug must be 3–32 characters (letters, numbers, - or _).",
      )
      .optional()
      .or(z.literal("")),
...
const urlQRColorsSchema = z.object({
  qrFgColor: z
    .string()
    .regex(/^#([0-9A-Fa-f]{3}|[0-9A-Fa-f]{6})$/, "Invalid qrFgColor hex value")
    .optional(),
  qrBgColor: z
    .string()
    .regex(/^#([0-9A-Fa-f]{3}|[0-9A-Fa-f]{6})$/, "Invalid qrBgColor hex value")
    .optional(),
});
...
module.exports = {
  ...
  resendVerificationValidator: validate(
    resendVerificationSchema,
    "body",
    "resend-verification",
  ),
