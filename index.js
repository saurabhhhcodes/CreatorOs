...
function buildAnalyticsViewModel() {
  return {
    ...
    topPosts: [
      {
        title: "How I plan 30 days of content",
        type: "Reel",
        likes: "14.2K",
        comments: "612",
        engagement: "14.9%",
      ...
      {
        title: "Creator OS desk setup walkthrough",
        type: "Carousel",
        likes: "11.8K",
        comments: "488",
        engagement: "12.4%",
      ...
      {
        title: "5 hooks that increased watch time",
        type: "Reel",
        likes: "9.6K",
        comments: "371",
        engagement: "10.1%",
      ...
      {
        title: "Behind the scenes: newsletter build",
        type: "Post",
        likes: "7.4K",
        comments: "284",
        engagement: "8.7%",
    ...
    timeline: [
      {
        title: "Top post detected",
        detail: "Planning reel crossed 14.9% engagement.",
        time: "Today, 4:20 PM",
      },
      {
        title: "Audience growth spike",
        detail: "Followers increased by 2.3K over the last 48 hours.",
        time: "Today, 11:10 AM",
      },
      {
        title: "Weekly consistency check",
        detail: "Posting cadence stayed above 5 posts per week.",
        time: "Yesterday",
      },
      {
        title: "Profile snapshot saved",
        detail: "Mock analytics snapshot prepared for dashboard UI.",
        time: "24 May",
      },
    ],
  };
...
app.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      return res.render(
        "home",
        buildShortenerViewModel(req, null, "An unexpected error occurred."),
      );
    }
  },
);
